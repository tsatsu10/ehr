...
| Document | Purpose |
|----------|---------|
| [NEW_CLINIC_OPENEMR_GAP_ANALYSIS_AND_REDESIGN_PLAN.md](./new/NEW_CLINIC_OPENEMR_GAP_ANALYSIS_AND_REDESIGN_PLAN.md) | Coverage audit vs stock OpenEMR menu tree + phased GAP-A–D React redesign plan; GAP-A/C/D essentially complete, GAP-B core built. Remaining real work: B1 outreach SMS gateway + wizard/scheduling (G6), D1 i18n string sweep (3/25 islands), B2b growth-chart overlay (blocked on sourcing verified LMS data). W5/W7/W8/W12 (Tier-2 "convert the wrapper" items) re-verified 2026-07-13 and closed — mostly already done, doc rot (v0.1.33) |
