...
| [AJAX_ACTION_ACL_MATRIX.md](./new/AJAX_ACTION_ACL_MATRIX.md) | SEC-1 living control: every dispatchable ajax action → policy type → required ACL → deferred re-auth (249 rows) |
