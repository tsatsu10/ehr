...
export function RegistryFilterPanel({
  ...
  return (
    <div className="nc-registry-filter-fields">
      <fieldset className="nc-registry-filter-group">
        <legend className="nc-registry-filter-group__legend">Demographics & identity</legend>
        <div className="nc-registry-filter-grid">
      ...
      <div className="nc-registry-filter-advanced">
        <details className="nc-registry-filter-section nc-registry-visit-filters">
          <summary>Visit filters</summary>
          <div className="nc-registry-filter-grid nc-registry-filter-grid--compact">
            <div className="nc-form-group nc-registry-filter-grid__full">
              ...
              <span className="nc-registry-filter-hint">Ctrl+click to select multiple</span>
            </div>
            <div className="nc-form-group">
        ...
        <details className="nc-registry-filter-section nc-registry-clinical-filters">
          <summary>Clinical filters</summary>
          <div className="nc-registry-filter-grid nc-registry-filter-grid--compact">
            <div className="nc-form-group">
        ...
        <details className="nc-registry-filter-section nc-registry-comms-filters">
        ...
        <details className="nc-registry-filter-section nc-registry-scheduling-filters">
          <summary>Scheduling & recalls</summary>
          <div className="nc-registry-filter-grid nc-registry-filter-grid--compact">
            <div className="nc-form-group">
