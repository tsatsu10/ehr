...
export const QUEUE_FIELD_SECTIONS: AdminFieldSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'enable_native_history_editor',
        type: 'bool',
        label: 'Native background/history editor (GAP-D)',
        hint: 'When on, "Edit history" on the chart Background section opens a native drawer with a West-Africa-first field set — family health (incl. sickle cell), social habits (incl. herbal/traditional medicine and occupation), past-illness story, and screening dates — instead of the stock History form. Writes the same history record; the full stock editor stays one click away. patients/med write ACL enforced. Default OFF.',
        indent: 1,
      },
      {
        key: 'enable_native_history_full_form',
        type: 'bool',
        label: 'Native full History form (D-HIST-10)',
        hint: 'Requires the native background editor above. When on, the drawer’s "Full history form" link opens the full native History editor (adds WHO-PEN risk factors, sleep, and the extra family conditions incl. suicide/mental illness behind a reveal) instead of the stock history_full.php screen. Staff can switch between the quick and full views; the stock form stays reachable as "Advanced". Default OFF.',
        indent: 2,
      },
      {
