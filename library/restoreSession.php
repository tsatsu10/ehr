...
// Standalone pages (e.g. deep-linked from New Clinic desks) are top-level windows;
// stock forms call top.restoreSession() expecting tabs/main.php to have loaded this file.
if (typeof top !== 'undefined' && typeof top.restoreSession !== 'function') {
    top.restoreSession = restoreSession;
}
