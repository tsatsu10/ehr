...
class AjaxActionPolicy
{
    ...
    private const SINGLE_ACL = [
        ...
        'admin.setup.unmark_item' => 'new_admin',
    ...
    public function normalizeAction(string $action): string
    {
        return match ($action) {
            ...
            'admin_hub.setup_unmark' => 'admin.setup.unmark_item',
            'admin_hub.setup_complete' => 'admin.setup.complete',
            'admin_hub.setup_reopen' => 'admin.setup.reopen',
            'admin_hub.setup_provision_staff' => 'admin.setup.provision_staff',
