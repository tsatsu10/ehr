...
/**
 * Output-buffer injection for the ledger cash-profile wrapper (M11-F11)
 *
 * @package   OpenEMR
...
class LedgerCashProfileInjector
{
    private static bool $bufferStarted = false;

    public function __construct(
        private readonly LedgerCashProfileService $wrapService,
    ) {
    }
