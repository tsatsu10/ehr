...
foreach ($facilityIds as $facilityId) {
    $config->set('communications_hub_enable', '1', $facilityId);
    $config->set('enable_react_communications_hub', '1', $facilityId);
    echo "Set communications_hub_enable=1 for facility {$facilityId}.\n";
    echo "Set enable_react_communications_hub=1 for facility {$facilityId}.\n";
}

$hubOn = $config->isEnabled('communications_hub_enable', 0, $defaultFacilityId);
...
echo "  communications_hub_enable\n";
echo "  enable_react_communications_hub\n";
echo '  communications_hub_ready=' . ($hubOn && $reactOn ? 'yes' : 'no') . "\n";
